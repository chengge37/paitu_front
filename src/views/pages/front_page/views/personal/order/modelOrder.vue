        ...
        <div class="item-table">
          <div class="col1">
            <div style="width:88px;height:88px;margin-right:10px;">
				...
				class="cursor" @click="toModelDetail(item.model_id)"/>
			</div>
            <div class="right-dec">
              <span class="cursor word-hover" @click="toModelDetail(item.model_id)">{{item.title}}</span>
              <div>
                <span>工作时间：</span>
          ...
          <div class="col4">
            ...
            <span class="cursor word-hover" @click="util.toBuyOrder(0,item.id)">订单详情</span>
          </div>
          <div class="col5">
            <span class="cursor word-hover" v-if="item.pay_status==1" @click="util.toBuyOrder(0,item.id)">立即支付</span>
  ...
  export default {
    ...
    methods:{
      ...
      getOrders(params){
        ...
        this.getRequest(model.getModelOrder,{...params,uid:this.user_data.id}).then(res=>{
          console.log(res,'模特订单')
