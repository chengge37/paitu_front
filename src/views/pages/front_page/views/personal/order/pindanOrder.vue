<template>
  <div class="wrap">
        ...
        <div class="item-table">
          <div class="col1">
            <div style="width:88px;height:88px;margin-right:10px;">
            	<el-image  style="width:100%;height:100%;" fit="contain" :src="util.picExplode(item.photo)"
				class="cursor" @click="toTeamDetail(item.team_id)"/>
			</div>
            <div class="right-dec">
              <span class="cursor word-hover" @click="toTeamDetail(item.team_id)">{{item.title}}</span>
          ...
          <div class="col2">
            ...
            <span class="cursor word-hover" v-if="item.pay_status==4">退款状态</span>
          </div>
          <div class="col3">
          ...
          <div class="col4">
            ...
            <span class="cursor word-hover" @click="util.toBuyOrder(2,item.id)">订单详情</span>
          </div>
          <div class="col5">
    ...
    <!--退款窗口-->
    <user-refund-pay :show.sync="showRefund" :id="selectRefundId" type='7' @refundSuccess="refundSuccess" @closed="closeRefund"></user-refund-pay>
...
import { team } from "@config/api.js"
  export default {
    data(){
      return{
        noData:false,
    ...
    methods:{
      ...
      getOrders(params){
        ...
        this.getRequest(team.teamOrderList,{...params,is_user:1}).then(res=>{
