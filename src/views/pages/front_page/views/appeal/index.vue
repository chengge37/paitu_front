			...
			<div class="feedback_background">
				<div class="feedback_form">
					<el-form ref="form" :rules="rules" :model="form" label-width="120px">
						<el-form-item label="维权留言" prop="content">
						...
						<el-form-item label="您的手机号码" prop="mobile">
							<el-input placeholder="您的手机号码" v-model="form.mobile" class="el-input"></el-input>
						</el-form-item>
						<el-form-item label="您的邮箱" prop="email">
							<el-input placeholder="请输入您的邮箱" v-model="form.email" class="el-input"></el-input>
						</el-form-item>
						<el-form-item>
							<el-button type="primary" @click="onSubmit" class="button default-hover">提交</el-button>
